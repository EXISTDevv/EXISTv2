...
const string strMessageMagic = "Exist Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Exist", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Halloween starts earlier and earlier, just like Christmas.";
        CTransaction txNew;
        txNew.nTime = 1541456503;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1541456503;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1290085 : 1290085;
                
        assert(block.hashMerkleRoot == uint256("0xe87115c62cacd6231d3702b46ca8748a67fdb379296c7b668b305e5826351d0a"));
...
unsigned char pchMessageStart[4] = { 0x9a, 0xa0, 0xe8, 0xe1 };
